  ...
  return (
    <section className="sections h-[100vh]">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          I've embarked on numerous projects over the years, but these
          are the ones I hold closest to my heart. Many of them are
          open-source, so if you come across something that piques
            ...
            <div className="mt-5 flex flex-col">
              ...
              <div className="mt-5 flex items-center gap-2 font-poppins">
                <Link
                  ...
                  className={`font-semibold gradient  ${project.linkColor}`}
                >
                  Live Link
                </Link>
                <img
